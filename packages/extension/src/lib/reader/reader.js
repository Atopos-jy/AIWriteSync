    ...
    if (m && m.search) {
      ...
      if (d && h) {
        ...
        if (!isNaN(parseInt(S)) && !isNaN(parseInt(C)))
          return (m.searchParams.set(d, S), m.searchParams.set(h, C), m.href);
      }
    }
  }
  return null;
...
((ReaderArticleFinder = function (e) {
  ...
  (ReaderArticleFinder.prototype = {
    ...
    adoptableLeadingMedia: function () {
      ...
      (f && u.setAttribute("src", f),
        (!f && u.hasAttribute("src")) ||
    ...
    cleanArticleNode: function (e, t, n, i) {
      ...
      for (var j = [], G = [], X = [], Y = [], K = []; b; ) {
        try {
          ...
          if (
            ...
            (d.has($) || (this.isAMPPage() && g.has($))) && (J = C),
            !J && b !== e && R.has(b)
              ? (J = C)
              : !J && b !== e && F.has(b)
          ...
          if (
            ...
            if (
              ...
              if (z && !N && cachedElementBoundingRect(b).top < z.top) J = C;
                ...
                for (
                  var ue = b.children, fe = ue.length, ge = !0, pe = 0;
                  pe < fe;
                  ++pe
                ) {
                  var Ee = ue[pe],
            ...
            if ("table" === $) y || (y = 1);
              ...
              if (
                ...
                ("left" !== Re && "right" !== Re) ||
                  (C.classList.add("float"), C.classList.add(Re)),
                !T && !Z)
              ) {
                var Fe,
              ...
              if (
                ...
                if (!J) {
                  ...
                  if (
                    ...
                    Pe.width > AnchorImageMinimumWidth &&
                      Pe.height > AnchorImageMinimumHeight &&
                ...
                var Be = b.children;
                1 === Be.length &&
                  "img" === normalizedElementTagName(Be[0]) &&
                  !b.innerText &&
          ...
          if (Q && w && !Z) {
            ...
            if (
              ...
              (!!P && v === P.depth && selectorForElement(b) === P.selector) ||
                W(b, e) ||
                (J = C);
          }
          if (
        ...
        if (!$e) {
          for (
            var rt = Ze.originalElement.getElementsByTagName("img"),
              ...
              lt = 0,
              ot = 0;
            ot < at && (w && isElementVisible(rt[ot]) && lt++, !(lt > 1));
            ++ot
          );
      ...
      for (pe = 0; pe < dt; ++pe) {
        (mt[(ht = (gt = et[pe]).style.fontWeight)] || (mt[ht] = []),
          mt[ht].push(gt));
      }
      for (var ht in mt) {
        var ut = mt[ht],
        ...
        if (ft > 0.7 * dt)
          for (pe = 0; pe < ft; ++pe) {
            var gt;
            (((gt = ut[pe]).style.fontWeight = null),
              gt.getAttribute("style") || gt.removeAttribute("style"));
          }
      }
      ...
      for (pe = 0; pe < yt; ++pe) {
        for (
          var At = Tt[pe], St = [At], Nt = At.nextElementSibling;
          Nt &&
          "p" === normalizedElementTagName(Nt) &&
          Nt.classList.contains("auxiliary");
        )
          (St.push(Nt), (Nt = Nt.nextElementSibling));
        var bt = St.length;
        if (bt > 1) {
          for (ot = 0; ot < bt; ++ot) {
            var xt = St[ot];
      ...
      for (pe = 0; pe < It; ++pe) {
        var Mt = j[pe],
          ...
          Rt = null;
        if (Lt)
          ((wt = depthOfElementWithinElement(Lt, t)),
    ...
    adoptableSimpleTweetFromTwitterElement: function (e) {
      ...
      for (
        var g = l.getElementsByTagName("*"), p = g.length, E = 0;
        E < p;
        ++E
      ) {
        e = g[E];
    ...
    articleTitleInformation: function () {
      ...
      this._leadingMediaElement) &&
        (k =
          (cachedElementBoundingRect(this._leadingMediaElement).top + B) / 2);
        ...
        for (V = 0; V < te; ++V) {
          ...
          if (!y.test(he.className)) {
            ...
            if (ue !== M || !I) {
              ...
              (Be &&
                (c.test(Be.className) || c.test(Be.getAttribute("id"))) &&
                (Me *= m),
    ...
    scoreNextPageLinkCandidate: function (e) {
      ...
      if (
        ((LinkURLPageSlashNumberMatchRegex.test(e.href) ||
          ...
          (S = !0),
        !S && m === u && stringSimilarity(o, s) < LinkMinimumURLSimilarityRatio)
      )
        return 0;
    ...
    elementContainsEnoughTextOfSameStyle: function (e, t, n) {
      ...
      for (var g in s) if (s[g] > o) return !0;
      return !1;
    },
